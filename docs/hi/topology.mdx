...
Cloud स्क्रबिंग सेंटर्स से कनेक्ट होने वाले **xDC_NAMEx** डेटा सेंटर
के लिए कॉन्फ़िगरेशन।
...
GRE बाहरी एंडपॉइंट IP भी सार्वजनिक रूप से रूटेबल होने चाहिए जब टनल
सार्वजनिक इंटरनेट से गुजरती हैं; निजी कनेक्टिविटी (L2, प्राइवेट
...
रिडंडेंसी के लिए, विभिन्न भौगोलिक रूप से स्थित स्क्रबिंग सेंटर्स के लिए **प्रति BIG-IP यूनिट 2 टनल** बनाएं
(एक HA जोड़ी के लिए कुल 4 टनल)।
:::
...
टनल कॉन्फ़िगरेशन बनाते समय संदर्भ के रूप में निम्नलिखित XC और BIG-IP वर्कशीट का उपयोग करें।

### XC

**टनल C1-T1 — सेंटर 1 से BIG-IP-A:**

- GRE बाहरी IP (टनल एंडपॉइंट के लिए):
    - IPv4 SRC: `xXC_C1_OUTER_V4x/24`
    - IPv4 DST: `xBIGIP_A_OUTER_V4x/24`
    - IPv6 SRC: `xXC_C1_OUTER_V6x/64`
    - IPv6 DST: `xBIGIP_A_OUTER_V6x/64`

- GRE आंतरिक IP (BGP सत्र के लिए):
...
:::note[आंतरिक (ट्रांज़िट) IP]
`10.10.10.0/30` जैसे आंतरिक IP, RFC 1918 पतों का उपयोग करते हैं। यह
...
सार्वजनिक रूप से रूटेबल होने चाहिए; बाहरी एंडपॉइंट IP सार्वजनिक रूप से रूटेबल होने चाहिए जब
टनल सार्वजनिक इंटरनेट से गुजरती हैं।
:::

:::note[IPv6 आंतरिक लिंक]
IPv6 आंतरिक लिंक यहाँ सामान्य Cloud डिफ़ॉल्ट से मिलान करने के लिए /64 प्रीफ़िक्स का उपयोग करते हैं।
पॉइंट-टू-पॉइंट लिंक के लिए, नेबर-डिस्कवरी एग्ज़ॉशन से बचने के लिए
[RFC 6164](https://datatracker.ietf.org/doc/html/rfc6164) के अनुसार /127 को प्राथमिकता दी जाती है। यदि
SOC टनल असाइनमेंट इसका समर्थन करता है तो /127 का उपयोग करें।
:::

### BIG-IP

**BIG-IP-A** (बाहरी IP `xBIGIP_A_OUTER_V4x` / `xBIGIP_A_OUTER_V6x`):

...
प्रत्येक यूनिट पर उसकी अपनी टनल के लिए चलाएँ:
...
1. सत्यापित करें कि GRE टनल चालू है: `show net tunnels tunnel` में
   स्थिति `up` दिखनी चाहिए।
1. पुष्टि करें कि inner self IP पर `allow-service` में `tcp:179` शामिल है।
1. टनल के माध्यम से रिमोट inner IP को पिंग करें।
1. जाँचें कि BGP पासवर्ड दोनों तरफ मेल खाता है (`NOTIFICATION`
   त्रुटियों का सामान्य कारण)।
1. सत्यापित करें कि prefix-lists और route-maps सही ढंग से लागू हैं।
1. अंतिम त्रुटि/रीसेट कारण के लिए `show ip bgp neighbors <IP>`
   जाँचें।
1. प्रत्येक HA यूनिट पर, सत्यापित करें कि उस यूनिट की अपनी टनल चालू हैं और उसके
   अपने BGP नेबर कॉन्फ़िगर हैं (दूसरी यूनिट के नहीं)।
:::

### XC कंसोल

**DDoS and Transit Services >
[DDoS Protection > Visibility](https://docs.cloud.f5.com/docs-v2/ddos-and-transit-services/how-tos/network-firewall/l3l4-ddos-mitigation)** पर नेविगेट करें और देखें:

- नेटवर्क, ज़ोन, एप्लिकेशन के अनुसार ट्रैफ़िक।
- ब्लॉक किया गया बनाम अनुमत ट्रैफ़िक।
- अटैक विवरण और स्क्रबिंग कार्रवाइयाँ।
